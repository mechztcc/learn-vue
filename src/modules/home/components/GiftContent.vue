    ...
    <v-card class="pa-5 background rounded-xl ma-12">
      <v-row>
        <v-col cols="12" md="6" lg="6" class="d-flex flex-column align-start justify-center">
          ...
          <v-btn outline color="primary" rounded="xl" size="x-large" variant="outlined" append-icon="mdi-chevron-right" @click="test()">Learn more</v-btn>
        </v-col>
        <v-col cols="12" md="6" lg="6">
          <v-container>
            <v-row>
              <v-col cols="6" md="6" lg="6">
                <v-card class="d-flex flex-column justify-center align-center pa-14 rounded-shaped card">
                  <div class="rounded-circle pa-2 bg-secondary">
